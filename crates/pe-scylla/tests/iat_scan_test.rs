...
use pe_edit::domain::{DataDirectoryIndex, Rva, ScanMethod, ScanOptions};
use pe_edit::io::{MOCK_APIS_BASE, MOCK_IAT_RVA, MOCK_IDATA_RVA, MOCK_TEXT_RVA, MockResolver};
use pe_scylla::api::IatScanner;
...
fn resolver_scan_groups_across_null_separators() {
    ...
    use pe_edit::domain::{DataDirectory, RawOffset, Section, SectionHeader};
...
fn code_reference_scan_signature_mode_without_resolution() {
    ...
    use pe_scylla::api::{ImportResolver, ResolvedImport};
    struct NoResolver;
...
fn code_reference_scan_finds_non_rax_register_variants() {
    ...
    use pe_edit::domain::section::{IMAGE_SCN_CNT_CODE, IMAGE_SCN_MEM_EXECUTE, IMAGE_SCN_MEM_READ};
    use pe_edit::domain::{RawOffset, Section, SectionHeader};
