...
use pe_edit::domain::{IatEntry, IatFixOptions, IatTable, Rva};
use pe_edit::io::pe::{parse, serialize};
use pe_edit::io::{MOCK_APIS_BASE, MOCK_IAT_RVA, MockResolver};
use pe_scylla::api::{IatFixer, PeViewer};
...
fn iat_table_from_scan_curation() {
    use pe_edit::domain::ScanOptions;
