...
use pe_edit::api::{DirectoryEditor, PeViewer};
use pe_edit::domain::load_config::IMAGE_GUARD_CF_FUNCTION_TABLE_PRESENT;
use pe_edit::domain::relocation::IMAGE_REL_BASED_HIGHLOW;
use pe_edit::domain::resource::RT_MANIFEST;
use pe_edit::domain::{ResourceEntryData, ResourceName, Rva};
use pe_edit::io::pe::{parse, serialize};
use pe_edit::io::{MOCK_IMAGE_BASE, MOCK_RSRC_RVA};
