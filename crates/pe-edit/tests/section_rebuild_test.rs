...
use pe_edit::api::{PeEditor, PeViewer};
use pe_edit::domain::section::{IMAGE_SCN_CNT_INITIALIZED_DATA, IMAGE_SCN_MEM_READ};
use pe_edit::domain::{
...
fn contiguous_doc() -> pe_edit::domain::PeDocument {
...
fn non_contiguous_doc() -> pe_edit::domain::PeDocument {
    use pe_edit::domain::export::{ExportSymbol, ExportTable};
    use pe_edit::domain::relocation::{RelocationBlock, RelocationEntry, RelocationTable};
    use pe_edit::domain::resource::{
